...
public class kalenGameManager : MonoBehaviour
{
    ...
    private void TriggerBadInputAnimation()
    {
        if (badInputAnimator != null)
        {
            badInputAnimator.Play("Bad_Input", 0, 0f);
        }
    }
    ...
    private void SubtractScore()
    {
        ...
        currScore = Mathf.Max(0, currScore - 1);
